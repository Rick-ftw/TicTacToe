      ...
      <div className="nav_btn_container">
        {windowWidth < 768 ? (
          ...
          <>
            ...
            >
              <MenuItem name="Easy" onClick={(e) => handleClose(e)}>
                Easy
              </MenuItem>
              <MenuItem name="Hard" onClick={(e) => handleClose(e)}>
                Hard
              </MenuItem>
              <MenuItem name="Impossible" onClick={(e) => handleClose(e)}>
                Impossible
              </MenuItem>
            </Menu>
          </>
        )}
        <p className="current_theme_name" style={{ opacity: "0%" }}>
          {windowWidth > 768 ? currentTheme : ""}
        </p>
      </div>
    </ThemeProvider>
  );
